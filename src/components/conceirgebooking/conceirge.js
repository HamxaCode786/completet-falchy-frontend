  ...
  const cardDetails = [
    {
      ...
      icons1: [
        { icon: "fa-solid fa-bottle-water", text: { en: "Water Bottle", it: "Bottiglia d'acqua", du: "Waterfles", fr: "Bouteille d'eau" } },
        { icon: "fa-wifi", text: { en: "Wifi", it: "Wifi", du: "Wifi", fr: "Wifi" } },
        { icon: "fa-car", text: { en: "Luxury Transportation", it: "Trasporti di lusso", du: "Luxe Vervoer", fr: "Transport de luxe" } },
        { icon: "fa-gem", text: { en: "Luxury", it: "Lusso", du: "Luxe", fr: "Luxe" } }
      ],
      icons2: [
        { icon: "fa-car", text: { en: "Valet Parking", it: "Parcheggio con valet", du: "Valet Parking", fr: "Parking avec voiturier" } },
        { icon: "fa-star", text: { en: "Luxury Ambiance", it: "Ambiente di lusso", du: "Luxe Ambiance", fr: "Ambiance de luxe" } },
        { icon: "fa-music", text: { en: "Acoustic Music", it: "Musica acustica", du: "Akoestische muziek", fr: "Musique acoustique" } },
        { icon: "fa-taxi", text: { en: "Transportation", it: "Trasporto", du: "Vervoer", fr: "Transport" } }
      ]
    }
    ,
    {
      ...
      icons2: [
        { icon: "fa-hot-tub", text: { en: "Massage", it: "Massaggio", du: "Massage", fr: "Massage" } },
        { icon: "fa-leaf", text: { en: "Holistic Health", it: "Salute Olistica", du: "Holistische Gezondheid", fr: "Santé Holistique" } },
        { icon: "fa-peace", text: { en: "Meditation", it: "Meditazione", du: "Meditatie", fr: "Méditation" } },
        { icon: "fa-star", text: { en: "Premium Service", it: "Servizio Premium", du: "Premium Service", fr: "Service Premium" } }
      ]
    }
    ,

    {
      ...
      icons2: [
        { icon: "fa-chair", text: { en: "Seating", it: "Posti a sedere", du: "Zitplaatsen", fr: "Sièges" } },
        { icon: "fa-video", text: { en: "Video Setup", it: "Setup Video", du: "Video Setup", fr: "Configuration Vidéo" } },
        { icon: "fa-clipboard-list", text: { en: "Registration", it: "Registrazione", du: "Registratie", fr: "Inscription" } },
        { icon: "fa-coffee", text: { en: "Catering", it: "Catering", du: "Catering", fr: "Restauration" } }
      ]
    }
    ,
    {
      ...
      icons2: [
        { icon: "fa-file-contract", text: { en: "Documentation", it: "Documentazione", du: "Documentatie", fr: "Documentation" } },
        { icon: "fa-user-tie", text: { en: "Professional Advisors", it: "Consulenti Professionali", du: "Professionele Adviseurs", fr: "Conseillers professionnels" } },
        { icon: "fa-globe", text: { en: "International Services", it: "Servizi Internazionali", du: "Internationale Diensten", fr: "Services Internationaux" } },
        { icon: "fa-clock", text: { en: "24/7 Support", it: "Supporto 24/7", du: "24/7 Ondersteuning", fr: "Assistance 24/7" } }
      ]
    }
    ,
    {
      ...
      icons2: [
        { icon: "fa-tools", text: { en: "Maintenance", it: "Manutenzione", du: "Onderhoud", fr: "Entretien" } },
        { icon: "fa-tasks", text: { en: "Task Management", it: "Gestione delle Attività", du: "Taakbeheer", fr: "Gestion des Tâches" } },
        { icon: "fa-calendar-alt", text: { en: "Scheduling", it: "Pianificazione", du: "Planning", fr: "Planification" } },
        { icon: "fa-concierge-bell", text: { en: "Concierge Support", it: "Supporto Concierge", du: "Concierge Support", fr: "Support Concierge" } }
      ]
    }
    ,
    {
      ...
      icons2: [
        { icon: "fa-passport", text: { en: "VIP Airport Services", it: "Servizi VIP per Aeroporti", du: "VIP Luchthavenservice", fr: "Services VIP Aéroport" } },
        { icon: "fa-route", text: { en: "Travel Planning", it: "Pianificazione Viaggi", du: "Reisplanning", fr: "Planification de Voyage" } },
        { icon: "fa-calendar-check", text: { en: "Itinerary Management", it: "Gestione Itinerari", du: "Reisroutebeheer", fr: "Gestion des Itinéraires" } },
        { icon: "fa-concierge-bell", text: { en: "24/7 Assistance", it: "Assistenza 24/7", du: "24/7 Assistentie", fr: "Assistance 24/7" } }
      ]
    }
